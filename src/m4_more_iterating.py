...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 3
    actual = count_positive_sines([5, 4, 3, 2, 6, 7])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = -53
    actual = sum_first_n([23, -76, 5, 43], 2)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9
    expected = -17
    actual = sum_first_n([4, 12, -565, 432, 100, 7, 5, 8, 13], 5)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
